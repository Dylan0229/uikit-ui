...
export const Handle = styled.div<HandleProps>`
  background-color: ${({ theme }) => theme.isDark ? '#333342' : theme.toggle.handleBackground};
  border-radius: 50%;
  cursor: pointer;
...
const StyledToggle = styled.div<ToggleProps>`
  align-items: center;
  background-color: ${({ theme, checked }) => checked ? (theme.isDark ? '#E89D39' : theme.toggle.background) : theme.colors.input};
  border-radius: 24px;
